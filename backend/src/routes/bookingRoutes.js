...
const { autoAssignSeatsSchema, createBookingSchema, seatLockSchema, verifyPaymentSchema } = require('../validators/bookingValidator')
...
router.post('/auto-assign', protect, bookingLimiter, validateRequest(autoAssignSeatsSchema), autoAssignSeats)
